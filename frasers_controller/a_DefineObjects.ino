...
const int IH_MAX = 25, IH_MIN = 13; //max and min water temperature
const int BH_MAX = 24.8, BH_MIN = 13.4; //max and min box temperature
const int RH_MAX = 89.1, RH_MIN = 49.6; //max and min relative humidity
