...
const int IH_MAX = 13, IH_MIN = 1.0; //max and min water temperature
const int BH_MAX = 9.5, BH_MIN = -3; //max and min box temperature
const int RH_MAX = 85.5, RH_MIN = 45.8; //max and min relative humidity
